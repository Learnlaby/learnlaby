...
export default function StudentWorkPage() {
    ...
    return (
        <div className="flex flex-col h-screen bg-white">
            ...
            <div className="border-b p-4 flex justify-between items-center">
                <div className="ml-4">
                    ...
                    <div className="flex items-center mt-3">
                        ...
                        <div
                            className={`flex items-center text-sm ${status === "Graded"
                                ? "text-green-600"
                                : status === "Turned in"
                                    ? "text-purple-600"
                                    : "text-gray-600"
            ...
            {message && (
                <div className="bg-green-100 text-green-800 border border-green-300 px-4 py-2 text-sm text-center">
                    {message}
                </div>
            )}
                            ...
                            {files.length > 0 ? (
                                files.map((file) => (
                                    <button
                                        ...
                                        className={`w-full text-left flex items-center p-2 border rounded ${selectedFile?.id === file.id ? "bg-gray-100 border-purple-500" : "bg-white"
                                            }`}
                                    >
